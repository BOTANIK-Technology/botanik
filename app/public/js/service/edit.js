if (document.querySelector('.modal-edit') !== null) {
    ...
    function addressSelectors(id) {
        return document.getElementsByName('addresses-' + id + '[]')
    }

    function groupVal(id) {
        return getCheckedVal(document.getElementsByName('group-' + id))
    }
    ...
    function send(id) {
        return {
            ...
            'timetable': getCookie('timetable-' + id),
