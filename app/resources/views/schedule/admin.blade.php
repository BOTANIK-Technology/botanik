...
<header class="flex align-items-center">
    <a href="{{route('window.schedule', ['business' => $slug, 'modal' => 'create'])}}" class="btn full-width text-decoration-none flex justify-content-around align-items-center">{!! file_get_contents(public_path('images/add-w.svg')) !!}
        записать клиента</a>
</header>
@endslot
                ...
                <tr>
                    ...
                    <td>
                        <div class="schedule_table-btns">
                            <a href="{{route('window.schedule', ['business' => $slug, 'modal' => 'view', 'id' => $item->service_id, 'current_month' => $current_month, 'current_type' => $current_type, 'date' => $date, 'time' => $item->time])}}" class="schedule_table-btn">
                                <div class="view-icon"></div>
                            </a>
                            <a href="{{route('window.schedule', ['business' => $slug, 'modal' => 'edit', 'id' => $item->service_id, 'current_month' => $current_month, 'current_type' => $current_type, 'date' => $date, 'time' => $item->time])}}" class="schedule_table-btn">
                                <div class="edit-icon"></div>
                            </a>
                            <a href="{{route('window.schedule', ['business' => $slug, 'modal' => 'delete', 'id' => $item->service_id, 'current_month' => $current_month, 'current_type' => $current_type, 'date' => $date, 'time' => $item->time])}}" class="schedule_table-btn">
